...
( {
  ...
  SeasonalSalads: {
    ...
    collection: [
      ...
      {
        name: [
          'Салат с ростбифом и нектарином',
          'Salad with roast beef and nectarine',
        ],
        weight: 230,
        cost: 14.50,
      },
        ...
        collection: [
          {
            ...
            weight: 380,
            cost: 14.20,
            img: '6512/466057584/photo_2021-08-12_13-09-23.jpg',
          },
          {
            name: [
              'с сёмгой',
            ...
            weight: 350,
            cost: 15.30,
            img: '6513/466057585/photo_2021-08-12_13-09-37.jpg',
          },
          {
            name: [
  ...
  WhiteWine: {
    ...
    collection: [
      ...
      {
        name: [
          'Metekhi Алазанская долина',
          'Metekhi Alazani Valley',
        ],
        weight: [
          'псл',
          's-sw',
      ...
      {
        name: 'IL Pumo Malvasia-Sauvignon',
        weight: [
          'псх',
          's-dr',
        ],
  ...
  RoseWine: {
    ...
    collection: [
      ...
      {
        name: 'Monterio Tempranillo Rosado',
        weight: [
            'сх',
            'dr',
        ],
  ...
  RedWine: {
    ...
    collection: [
      ...
      {
        name: [
          'Metekhi Киндзмараули',
          'Metekhi Kindzmarauli',
        ],
        weight: [
          'псл',
          's-sw',
      ...
      // {
      //   name: 'Folonari Merlot-Cabernet Sauvignon',
      //   weight: [
      //     'сх',
      //     'dr',
      //   ],
